...
if ($_SERVER['REQUEST_METHOD'] !== 'POST') {
    header('Location: ../../pages/khachHang/tour_ChiTiet.php?maTour=' . $maTour);
    exit();
}

if (!$maTour || empty($lyDo) || empty($noiDung)) {
    header('Location: ../../pages/khachHang/tour_ChiTiet.php?maTour=' . $maTour . '&error=thieu_thong_tin');
    exit();
}
...
if ($stmt->execute()) {
    header('Location: ../../pages/khachHang/tour_ChiTiet.php?maTour=' . $maTour . '&baocao=1');
} else {
    header('Location: ../../pages/khachHang/tour_ChiTiet.php?maTour=' . $maTour . '&error=loi_he_thong');
}
exit();